...
const SEED_INFLUENCERS = [
  ...
  { id: '2', name: 'Sasha Sun', platform: 'Instagram', reach: '450K', genre: 'Electronic', match: '92%', status: 'READY', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400' },
  { id: '3', name: 'VibeCheck', platform: 'TikTok', reach: '2.5M', genre: 'Indie', match: '88%', status: 'READY', avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400' },
  { id: '4', name: 'BeatRadar', platform: 'YouTube', reach: '800K', genre: 'Pop', match: '85%', status: 'READY', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400' },
  { id: '5', name: 'Luna Beats', platform: 'TikTok', reach: '3.1M', genre: 'Hyperpop', match: '95%', status: 'READY', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400' },
  { id: '6', name: 'SynthLord', platform: 'Instagram', reach: '120K', genre: 'Synthwave', match: '94%', status: 'READY', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400' },
];
