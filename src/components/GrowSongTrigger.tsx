...
export default function GrowSongTrigger() {
  ...
  return (
    <button
      onClick={open}
      className="beam flex items-center gap-1.5 px-3 py-1.5 bg-primary text-white text-[10px] font-mono font-black uppercase italic tracking-widest active:scale-95 transition-all shadow-[0_0_20px_rgba(255,77,0,0.3)]"
      title="Grow My Song"
    >
