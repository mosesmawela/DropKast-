...
// Hoist static animation configurations to prevent re-allocation on every render.
// This optimization is beneficial as AnimatedBeam is used ~34 times in the app.
const BEAM_ANIMATE = {
  top: ["0%", "0%", "100%", "100%", "0%"],
  left: ["0%", "100%", "100%", "0%", "0%"],
...
const BEAM_TRANSITION_PRIMARY = {
  duration: 4,
  repeat: Infinity,
  ease: "linear" as const,
};

const BEAM_TRANSITION_SECONDARY = {
  duration: 4,
  repeat: Infinity,
  ease: "linear" as const,
  delay: 2,
    ...
    <div className={cn("relative group transition-all duration-500", containerClassName)}>
      ...
      <div className="absolute inset-0 z-10 pointer-events-none overflow-hidden">
        <motion.div
          ...
          transition={BEAM_TRANSITION_PRIMARY}
          className={cn(
      ...
      <div className="absolute inset-0 z-10 pointer-events-none overflow-hidden rotate-180">
        <motion.div
          animate={BEAM_ANIMATE}
          transition={BEAM_TRANSITION_SECONDARY}
          className={cn(
