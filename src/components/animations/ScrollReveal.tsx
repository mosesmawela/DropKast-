...
// Hoisted static configurations to prevent redundant allocations on every render.
// This is especially impactful as ScrollReveal is used ~68 times across the app.
const DIRECTIONS = {
  up: { y: 40 },
  down: { y: -40 },
  left: { x: 40 },
...
const SCROLL_REVEAL_VARIANTS: Record<'fade' | 'blur' | 'slide', Variants> = {
  fade: {
