...
// ⚡ Bolt Optimization: Hoist static configurations to prevent re-allocation on every render.
// This is especially important for ScrollReveal which is used ~68 times in the app.
const DIRECTIONS = {
  up: { y: 40 },
  down: { y: -40 },
  left: { x: 40 },
