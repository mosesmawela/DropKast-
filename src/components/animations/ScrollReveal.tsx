...
// and reduce GC pressure, especially since ScrollReveal is used ~68 times in the app.
const DIRECTIONS = {
  up: { y: 40 },
  down: { y: -40 },
  left: { x: 40 },
    ...
    <div style={{ position: "relative", width, overflow: "visible" }} className={className}>
      <motion.div
        ...
        transition={{
          duration: 0.8,
          delay: delay,
          ease: EASE_CURVE as any // Cast to any to satisfy Framer Motion's easing type
        }}
      >
        {children}
      </motion.div>
