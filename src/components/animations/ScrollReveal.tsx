...
// Performance Optimization: Hoist static configuration to prevent re-allocation on every render.
// This is especially impactful for ScrollReveal as it's used ~68 times in the app.
const DIRECTIONS = {
  up: { y: 40 },
  down: { y: -40 },
  left: { x: 40 },
