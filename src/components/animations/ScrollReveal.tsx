...
// ⚡ Bolt: Hoist static configuration outside the component to prevent re-allocation on every render.
// This reduces GC pressure and memory usage, especially for components used frequently (~68 times).
const DIRECTIONS = {
  up: { y: 40 },
  down: { y: -40 },
  left: { x: 40 },
...
// ⚡ Bolt: Using 'as unknown as [number, number, number, number]' to satisfy Framer Motion's Easing type requirement
