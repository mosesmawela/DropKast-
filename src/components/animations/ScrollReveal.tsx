...
/**
 * ⚡ Bolt: Hoisted static configurations (DIRECTIONS, VARIANTS, VIEWPORT_CONFIG, TRANSITION_EASE)
 * outside the component body. Used the 'custom' prop to pass dynamic directions to variants.
 * This prevents redundant object allocations on every render cycle for a component used ~68 times.
 */
