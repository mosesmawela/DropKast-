...
// ⚡ Bolt: Hoist static configuration outside the component to avoid redundant allocations on every render.
// This is critical as ScrollReveal is used ~68 times across the application.
const DIRECTIONS = {
  up: { y: 40 },
  down: { y: -40 },
  left: { x: 40 },
...
// ⚡ Bolt: Use functional variants with 'custom' prop to handle dynamic directions
// without recreating the entire variants object on every render.
