...
export const STUDIOS: StudioDef[] = [
   ...
   * ===================================================================== */
  {
    ...
    status: 'coming-soon',
    comingSoonNote: 'Image generation provider being wired (Nano Banana / Gemini).',
    trust: 'ai-draft',
    category: 'visual',
    icon: ImageIcon,
    accentColor: '#FF4D00',
  ...
  },
  {
    ...
    status: 'coming-soon',
    comingSoonNote: 'Video generation being wired via Higgsfield (Kling / Veo / Sora).',
    trust: 'ai-draft',
    category: 'video',
    icon: Video,
    accentColor: '#FF4D00',
  ...
  },
  {
    ...
    status: 'coming-soon',
    comingSoonNote: 'Concept generation being wired to a real model.',
    trust: 'ai-draft',
    category: 'video',
    icon: Smile,
    accentColor: '#FF4D00',
  ...
  },
  {
    ...
    status: 'coming-soon',
    comingSoonNote: 'Lip-sync model being wired via Higgsfield (Seedance).',
    trust: 'ai-draft',
    category: 'video',
    icon: Mic2,
    accentColor: '#FF4D00',
  ...
  },
  {
    ...
    status: 'coming-soon',
    comingSoonNote: 'Being rebuilt to return real AI output (currently template-only).',
    trust: 'ai-draft',
    category: 'copy',
    icon: Layers,
    accentColor: '#FF4D00',
  ...
  },
  {
    ...
    status: 'coming-soon',
    comingSoonNote: 'Being rebuilt to return the real AI plan (currently template-only).',
    trust: 'ai-insight',
    category: 'strategy',
    icon: Target,
    accentColor: '#FF4D00',
  ...
  },
  {
    ...
    status: 'coming-soon',
    comingSoonNote: 'Audio hook-detection model not wired yet.',
    trust: 'ai-insight',
    category: 'audio',
    icon: Scissors,
    accentColor: '#FF4D00',
